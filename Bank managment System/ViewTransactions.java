...
public class ViewTransactions extends JFrame implements ActionListener {
    JButton viewTransactions, Details_Panel, manageCustomers, manageAccounts, notification, logout;
    JPanel detailsPanel;
    ...
    ViewTransactions() {
        ...
        notification = createButton("View Reports");
        ...
        // Title Label
        JLabel titleLabel = new JLabel("View Transactions Panel");
        titleLabel.setFont(new Font("Arial", Font.BOLD, 24));
        titleLabel.setForeground(new Color(80, 80, 80));
        titleLabel.setBounds(350, 100, 450, 30);
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (rs1.next()) {
                    ...
                    String query2 = "SELECT * FROM bank WHERE PIN_Number = '" + PinUser + "'";
                    ResultSet rs2 = conn.a.executeQuery(query2);
                    int yOffset = 260;
                    while (rs2.next()) {
                        String Date = rs2.getString("Date");
                        String AmountType = rs2.getString("Type");
                        String AmountUser = rs2.getString("Amount");

                        JLabel DateLabel = new JLabel("Date: " + Date);
                        DateLabel.setFont(new Font("Arial", Font.BOLD, 14));
                        DateLabel.setBounds(100, yOffset, 350, 30);
                        JLabel AmountTypeLabel = new JLabel("Amount ID: " + AmountType);
                        AmountTypeLabel.setFont(new Font("Arial", Font.BOLD, 14));
                        AmountTypeLabel.setBounds(450, yOffset, 350, 30);
                        JLabel AmountUserLabel = new JLabel("Amount: " + AmountUser);
                        AmountUserLabel.setFont(new Font("Arial", Font.BOLD, 14));
                        AmountUserLabel.setBounds(700, yOffset, 350, 30);

                        detailsPanel.add(DateLabel);
                        detailsPanel.add(AmountTypeLabel);
                        detailsPanel.add(AmountUserLabel);
                        yOffset += 20;
                    }
                }
