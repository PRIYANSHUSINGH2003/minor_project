...
public class LoadingScreen extends JFrame {
    ...
    public LoadingScreen() {
        ...
        upperPic = new JLabel();
        upperPic.setIcon(new ImageIcon(ClassLoader.getSystemResource("Icons/loadingIconImg.gif")));
        upperPic.setBounds(460, 70, 300, 300);
        ...
        textLbl = new JLabel("Welcome To Bank Management System");
        textLbl.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 55));
        textLbl.setForeground(Color.WHITE);
        textLbl.setBounds(100, 420, 1200, 80);
        mainPanel.add(textLbl);

        backgroundPic = new JLabel();
        backgroundPic.setIcon(new ImageIcon(ClassLoader.getSystemResource("Icons/background.jpg")));
